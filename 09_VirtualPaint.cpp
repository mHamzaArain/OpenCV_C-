...
vector<vector<int>> findColor(Mat img)
{
	...
	{
		Scalar upper(myColors[i][3], myColors[i][4], myColors[i][5]);  // higher range color
		Scalar lower(myColors[i][0], myColors[i][1], myColors[i][2]);  // lower range color
		Mat mask;
		inRange(imgHSV, lower, upper, mask); // Recognize color in range(i.e; light/dark red)
